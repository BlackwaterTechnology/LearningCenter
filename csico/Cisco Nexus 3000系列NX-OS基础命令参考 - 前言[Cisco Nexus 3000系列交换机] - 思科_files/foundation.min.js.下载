...
var Z=ab.La;
Z||(Z=!1);
ad.S=function(i){var k=0,h,j;
if(i){for(h=0;
h<i.length;
h++){j=i.charCodeAt(h),k=(k<<5)-k+j,k&=k
}}return k
};
ad.r=function(j){var q="0123456789",i="",o="",m,l=8,p=10,k=10;
if(1==j){q+="ABCDEF";
for(j=0;
16>j;
j++){m=Math.floor(Math.random()*l),i+=q.substring(m,m+1),m=Math.floor(Math.random()*l),o+=q.substring(m,m+1),l=16
}return i+"-"+o
}for(j=0;
19>j;
j++){m=Math.floor(Math.random()*p),i+=q.substring(m,m+1),0==j&&9==m?p=3:(1==j||2==j)&&10!=p&&2>m?p=10:2<j&&(p=10),m=Math.floor(Math.random()*k),o+=q.substring(m,m+1),0==j&&9==m?k=3:(1==j||2==j)&&10!=k&&2>m?k=10:2<j&&(k=10)
}return i+o
};
ad.ma=function(){var i;
!i&&Y.location&&(i=Y.location.hostname);
...
ad.cookieRead=function(i){var i=encodeURIComponent(i),k=(";"+W.cookie).split(" ").join(";"),h=k.indexOf(";"+i+"="),j=0>h?h:k.indexOf(";",h+1);
return 0>h?"":decodeURIComponent(k.substring(h+2+i.length,0>j?k.length:j))
};
ad.cookieWrite=function(j,k,a){var i=ad.cookieLifetime,h,k=""+k,i=i?(""+i).toUpperCase():"";
...
return j&&"NONE"!=i?(W.cookie=encodeURIComponent(j)+"="+encodeURIComponent(k)+"; path=/;"+(a?" expires="+a.toGMTString()+";":"")+(ad.cookieDomain?" domain="+ad.cookieDomain+";":""),ad.cookieRead(j)==k):0
};
ad.g=ac;
ad.A=function(i,j){try{"function"==typeof i?i.apply(Y,j):i[1].apply(i[0],j)
}catch(h){}};
ad.ra=function(a,h){h&&(ad.g==ac&&(ad.g={}),ad.g[a]==b&&(ad.g[a]=[]),ad.g[a].push(h))
};
ad.m=function(h,i){if(ad.g!=ac){var a=ad.g[h];
if(a){for(;
0<a.length;
){ad.A(a.shift(),i)
}}}};
ad.j=ac;
ad.oa=function(p,q,r){var o=0,m=0,l;
if(q&&W){for(l=0;
!o&&2>l;
){try{o=(o=W.getElementsByTagName(0<l?"HEAD":"head"))&&0<o.length?o[0]:0
}catch(a){o=0
}l++
}if(!o){try{W.body&&(o=W.body)
}catch(h){o=0
}}if(o){for(l=0;
!m&&2>l;
){try{m=W.createElement(0<l?"SCRIPT":"script")
}catch(k){m=0
}l++
}}}!q||!o||!m?r&&r():(m.type="text/javascript",m.setAttribute("async","async"),m.src=q,o.firstChild?o.insertBefore(m,o.firstChild):o.appendChild(m),ad.pa.Ka.push(q),r&&(ad.j==ac&&(ad.j={}),ad.j[p]=setTimeout(r,ad.loadTimeout)))
};
...
var m=ad.R(),p=Z,a=ad.cookieRead(ad.cookieName),l,k,j,o,h=new Date;
ad.a==ac&&(ad.a={});
if(a&&"T"!=a){a=a.split("|");
a[0].match(/^[\-0-9]+$/)&&(parseInt(a[0],10)!=m&&(p=aa),a.shift());
1==a.length%2&&a.pop();
for(m=0;
m<a.length;
m+=2){if(l=a[m].split("-"),k=l[0],j=a[m+1],1<l.length?(o=parseInt(l[1],10),l=0<l[1].indexOf("s")):(o=0,l=Z),p&&(k==Q&&(j=""),0<o&&(o=h.getTime()/1000-60)),k&&j&&(ad.c(k,j,1),0<o&&(ad.a["expire"+k]=o+(l?"s":""),h.getTime()>=1000*o||l&&!ad.cookieRead(ad.sessionCookieName)))){ad.d||(ad.d={}),ad.d[k]=aa
}}}if(!ad.b(U)&&(a=ad.cookieRead("s_vi"))){a=a.split("|"),1<a.length&&0<=a[0].indexOf("v1")&&(j=a[1],m=j.indexOf("["),0<=m&&(j=j.substring(0,m)),j&&j.match(/^[0-9a-fA-F\-]+$/)&&ad.c(U,j))
}}};
ad.ta=function(){var h=ad.R(),i,a;
for(i in ad.a){!Object.prototype[i]&&ad.a[i]&&"expire"!=i.substring(0,6)&&(a=ad.a[i],h+=(h?"|":"")+i+(ad.a["expire"+i]?"-"+ad.a["expire"+i]:"")+"|"+a)
}ad.cookieWrite(ad.cookieName,h,1)
};
ad.b=function(a,h){return ad.a!=ac&&(h||!ad.d||!ad.d[a])?ad.a[a]:ac
};
ad.c=function(h,i,a){ad.a==ac&&(ad.a={});
ad.a[h]=i;
a||ad.ta()
};
ad.na=function(h,i){var a=ad.b(h,i);
return a?a.split("*"):ac
};
ad.sa=function(h,i,a){ad.c(h,i?i.join("*"):"",a)
};
ad.Sa=function(j,k){var a=ad.na(j,k);
if(a){var i={},h;
for(h=0;
h<a.length;
h+=2){i[a[h]]=a[h+1]
...
ad.Ua=function(j,k,a){var i=ac,h;
if(k){for(h in i=[],k){Object.prototype[h]||(i.push(h),i.push(k[h]))
}}ad.sa(j,i,a)
};
ad.k=function(i,j,a){var h=new Date;
h.setTime(h.getTime()+1000*j);
ad.a==ac&&(ad.a={});
ad.a["expire"+i]=Math.floor(h.getTime()/1000)+(a?"s":"");
0>j?(ad.d||(ad.d={}),ad.d[i]=aa):ad.d&&(ad.d[i]=Z);
a&&(ad.cookieRead(ad.sessionCookieName)||ad.cookieWrite(ad.sessionCookieName,"1"))
};
ad.Q=function(h){if(h&&("object"==typeof h&&(h=h.d_mid?h.d_mid:h.visitorID?h.visitorID:h.id?h.id:h.uuid?h.uuid:""+h),h&&(h=h.toUpperCase(),"NOTARGET"==h&&(h=O)),!h||h!=O&&!h.match(/^[0-9a-fA-F\-]+$/))){h=""
}return h
};
ad.i=function(i,j){ad.ka(i);
ad.h!=ac&&(ad.h[i]=Z);
if(i==T){var a=ad.b(R);
if(!a){a="object"==typeof j&&j.mid?j.mid:ad.Q(j);
if(!a){if(ad.v){ad.getAnalyticsVisitorID(ac,Z,aa);
return
}a=ad.r()
}ad.c(R,a)
}if(!a||a==O){a=""
}"object"==typeof j&&((j.d_region||j.dcs_region||j.d_blob||j.blob)&&ad.i(c,j),ad.v&&j.mid&&ad.i(V,{id:j.id}));
ad.m(R,[a])
}if(i==c&&"object"==typeof j){a=604800;
j.id_sync_ttl!=b&&j.id_sync_ttl&&(a=parseInt(j.id_sync_ttl,10));
var h=ad.b(g);
h||((h=j.d_region)||(h=j.dcs_region),h&&(ad.k(g,a),ad.c(g,h)));
h||(h="");
ad.m(g,[h]);
h=ad.b(S);
if(j.d_blob||j.blob){(h=j.d_blob)||(h=j.blob),ad.k(S,a),ad.c(S,h)
}h||(h="");
ad.m(S,[h]);
!j.error_msg&&ad.t&&ad.c(Q,ad.t)
}if(i==V){a=ad.b(U);
a||((a=ad.Q(j))?ad.k(S,-1):a=O,ad.c(U,a));
if(!a||a==O){a=""
}ad.m(U,[a])
}ad.idSyncDisableSyncs?K.ba=aa:(K.ba=Z,a={},a.ibs=j.ibs,a.subdomain=j.subdomain,K.Ia(a));
j===Object(j)&&(a=O,j.d_optout&&j.d_optout instanceof Array&&(a=j.d_optout.join(",")),h=parseInt(j.d_ottl,10),isNaN(h)&&(h=7200),ad.k(e,h,!0),ad.c(e,a),ad.m(e,[a]))
};
ad.h=ac;
ad.n=function(k,l,a,j){var i="",h;
if(ad.isAllowed()&&(ad.f(),i=ad.b(k),!i&&(k==R||k==e?h=T:k==g||k==S?h=c:k==U&&(h=V),h))){if(l&&(ad.h==ac||!ad.h[h])){ad.h==ac&&(ad.h={}),ad.h[h]=aa,ad.oa(h,l,function(){if(!ad.b(k)){var m="";
k==R?m=ad.r():h==c&&(m={error_msg:"timeout"});
ad.i(h,m)
}})
}ad.ra(k,a);
l||ad.i(h,{id:O});
return""
}if((k==R||k==U)&&i==O){i="",j=aa
}a&&j&&ad.A(a,[i]);
return i
};
...
ad.v=Z;
ad.getMarketingCloudVisitorID=function(h,i){if(ad.isAllowed()){ad.marketingCloudServer&&0>ad.marketingCloudServer.indexOf(".demdex.net")&&(ad.v=aa);
...
ad.P=Z;
ad.t="";
ad.setCustomerIDs=function(j){if(ad.isAllowed()&&j){ad.f();
var k,a;
for(k in j){if(!Object.prototype[k]&&(a=j[k])){if("object"==typeof a){var i={};
a.id&&(i.id=a.id);
a.authState!=b&&(i.authState=a.authState);
ad.q[k]=i
}else{ad.q[k]={id:a}
}}}var j=ad.getCustomerIDs(),i=ad.b(Q),h="";
i||(i=0);
for(k in j){Object.prototype[k]||(a=j[k],h+=(h?"|":"")+k+"|"+(a.id?a.id:"")+(a.authState?a.authState:""))
}ad.t=ad.S(h);
ad.t!=i&&(ad.P=aa,ad.qa())
}};
ad.getCustomerIDs=function(){ad.f();
var h={},i,a;
for(i in ad.q){Object.prototype[i]||(a=ad.q[i],h[i]||(h[i]={}),a.id&&(h[i].id=a.id),h[i].authState=a.authState!=b?a.authState:ab.AuthState.UNKNOWN)
}return h
};
...
ad.getAnalyticsVisitorID=function(k,l,a){if(ad.isAllowed()){var j="";
a||(j=ad.getMarketingCloudVisitorID(function(){ad.getAnalyticsVisitorID(k,aa)
}));
if(j||a){var i=a?ad.marketingCloudServer:ad.trackingServer,h="";
ad.loadSSL&&(a?ad.marketingCloudServerSecure&&(i=ad.marketingCloudServerSecure):ad.trackingServerSecure&&(i=ad.trackingServerSecure));
i&&(h="http"+(ad.loadSSL?"s":"")+"://"+i+"/id?d_visid_ver="+ad.version+"&callback=s_c_il%5B"+ad._in+"%5D._set"+(a?"MarketingCloud":"Analytics")+"Fields&mcorgid="+encodeURIComponent(ad.marketingCloudOrgID)+(j?"&mid="+j:"")+(ad.idSyncDisable3rdPartySyncing?"&d_coppa=true":""));
return ad.n(a?R:U,h,k,l)
}}return""
};
ad._setAudienceManagerFields=function(a){ad.f();
ad.i(c,a)
};
ad.s=function(p){var q=ad.audienceManagerServer,a="",o=ad.b(R),m=ad.b(S,aa),l=ad.b(U),l=l&&l!=O?"&d_cid_ic=AVID%01"+encodeURIComponent(l):"";
ad.loadSSL&&ad.audienceManagerServerSecure&&(q=ad.audienceManagerServerSecure);
if(q){var a=ad.getCustomerIDs(),k,j;
if(a){for(k in a){Object.prototype[k]||(j=a[k],l+="&d_cid_ic="+encodeURIComponent(k)+"%01"+encodeURIComponent(j.id?j.id:"")+(j.authState?"%01"+j.authState:""))
}}p||(p="_setAudienceManagerFields");
a="http"+(ad.loadSSL?"s":"")+"://"+q+"/id?d_visid_ver="+ad.version+"&d_rtbd=json&d_ver=2"+(!o&&ad.v?"&d_verify=1":"")+"&d_orgid="+encodeURIComponent(ad.marketingCloudOrgID)+"&d_nsid="+(ad.idSyncContainerID||0)+(o?"&d_mid="+o:"")+(ad.idSyncDisable3rdPartySyncing?"&d_coppa=true":"")+(m?"&d_blob="+encodeURIComponent(m):"")+l+"&d_cb=s_c_il%5B"+ad._in+"%5D."+p
}return a
};
ad.getAudienceManagerLocationHint=function(h,i){if(ad.isAllowed()&&ad.getMarketingCloudVisitorID(function(){ad.getAudienceManagerLocationHint(h,aa)
})){var a=ad.b(U);
a||(a=ad.getAnalyticsVisitorID(function(){ad.getAudienceManagerLocationHint(h,aa)
}));
if(a){return a=ad.s(),ad.n(g,a,h,i)
}}return""
};
ad.getAudienceManagerBlob=function(h,i){if(ad.isAllowed()&&ad.getMarketingCloudVisitorID(function(){ad.getAudienceManagerBlob(h,aa)
})){var a=ad.b(U);
a||(a=ad.getAnalyticsVisitorID(function(){ad.getAudienceManagerBlob(h,aa)
}));
if(a){return a=ad.s(),ad.P&&ad.k(S,-1),ad.n(S,a,h,i)
}}return""
};
ad.o="";
ad.u={};
ad.D="";
ad.F={};
ad.getSupplementalDataID=function(h,i){!ad.o&&!i&&(ad.o=ad.r(1));
var a=ad.o;
ad.D&&!ad.F[h]?(a=ad.D,ad.F[h]=aa):a&&(ad.u[h]&&(ad.D=ad.o,ad.F=ad.u,ad.o=a=!i?ad.r(1):"",ad.u={}),a&&(ad.u[h]=aa));
return a
};
ab.OptOut={GLOBAL:"global"};
ad.getOptOut=function(h,i){if(ad.isAllowed()){var a=ad.s("_setMarketingCloudFields");
return ad.n(e,a,h,i)
}return""
};
ad.isOptedOut=function(h,i,a){return ad.isAllowed()?(i||(i=ab.OptOut.GLOBAL),(a=ad.getOptOut(function(j){ad.A(h,[j==ab.OptOut.GLOBAL||0<=j.indexOf(i)])
},a))?a==ab.OptOut.GLOBAL||0<=a.indexOf(i):ac):Z
};
var J={l:!!Y.postMessage,ha:1,O:86400000};
ad.Oa=J;
ad.X={postMessage:function(i,k,h){var j=1;
k&&(J.l?h.postMessage(i,k.replace(/([^:]+:\/\/[^\/]+).*/,"$1")):k&&(h.location=k.replace(/#.*$/,"")+"#"+ +new Date+j+++"&"+i))
},K:function(i,k){var h;
try{if(J.l){if(i&&(h=function(a){if("string"===typeof k&&a.origin!==k||"[object Function]"===Object.prototype.toString.call(k)&&!1===k(a.origin)){return !1
}i(a)
...
var n={Y:function(){if(W.addEventListener){return function(i,j,h){i.addEventListener(j,function(k){"function"===typeof h&&h(k)
},Z)
}
}if(W.attachEvent){return function(i,j,h){i.attachEvent("on"+j,function(k){"function"===typeof h&&h(k)
})
}
}}(),map:function(i,m){if(Array.prototype.map){return i.map(m)
}if(void 0===i||i===ac){throw new TypeError
...
ad.Ta=n;
var K={ia:30000,N:649,fa:Z,id:ac,I:ac,aa:function(h){if("string"===typeof h){return h=h.split("/"),h[0]+"//"+h[2]
}},e:ac,url:ac,Aa:function(){var a="http://fast.",h="?d_nsid="+ad.idSyncContainerID+"#"+encodeURIComponent(W.location.href);
...
},ba:ac,H:Z,M:Z,w:ac,hb:ac,Ga:ac,ib:ac,L:Z,z:[],Ea:[],Fa:[],ca:J.l?15:100,J:[],Ca:[],$:aa,da:Z,Z:function(){function i(){j=document.createElement("iframe");
j.id=h.id;
...
}function k(){n.Y(j,"load",function(){j.className="aamIframeLoaded";
h.w=aa;
h.p()
})
}this.M=aa;
var h=this,j=document.getElementById(this.id);
j?"IFRAME"!==j.nodeName?(this.id+="_2",i()):"aamIframeLoaded"!==j.className?k():(this.w=aa,this.p()):i();
this.Ba=j
},p:function(a){var h=this;
a===Object(a)&&this.J.push(a);
if((this.da||!J.l||this.w)&&this.J.length){this.Ha(this.J.shift()),this.p()
}!ad.idSyncDisableSyncs&&this.w&&this.z.length&&!this.L&&(this.fa||(this.fa=aa,setTimeout(function(){h.ca=J.l?15:150
},this.ia)),this.L=aa,this.ea())
},Ha:function(j){var p=encodeURIComponent,i,o,m,l,k;
if((i=j.ibs)&&i instanceof Array&&(o=i.length)){for(m=0;
m<o;
m++){l=i[m],k=[p("ibs"),p(l.id||""),p(l.tag||""),n.za(l.url||[],","),p(l.ttl||""),"","",l.fireURLSync?"true":"false"],this.$?this.G(k.join("|")):l.fireURLSync&&this.wa(l,k.join("|"))
}}this.Ca.push(j)
},wa:function(k,l){ad.f();
var a=ad.b(P),j=Z,i=Z,h=Math.ceil((new Date).getTime()/J.O);
if(a){if(a=a.split("*"),i=this.Ja(a,k.id,h),j=i.xa,i=i.ya,!j||!i){this.G(l),a.push(k.id+"-"+(h+Math.ceil(k.ttl/60/24))),this.Da(a),ad.c(P,a.join("*"))
}}else{this.G(l),ad.c(P,k.id+"-"+(h+Math.ceil(k.ttl/60/24)))
}},Ja:function(k,r,j){var q=Z,p=Z,o,m,l;
for(m=0;
m<k.length;
m++){o=k[m],l=parseInt(o.split("-")[1],10),o.match("^"+r+"-")?(q=aa,j<l?p=aa:(k.splice(m,1),m--)):j>=l&&(k.splice(m,1),m--)
}return{xa:q,ya:p}
},Da:function(h){if(h.join("*").length>this.N){for(h.sort(function(j,i){return parseInt(j.split("-")[1],10)-parseInt(i.split("-")[1],10)
});
h.join("*").length>this.N;
){h.shift()
}}},G:function(a){var h=encodeURIComponent;
this.z.push((ad.Qa?h("---destpub-debug---"):h("---destpub---"))+a)
},ea:function(){var a=this,h;
this.z.length?(h=this.z.shift(),ad.X.postMessage(h,this.url,this.Ba.contentWindow),this.Ea.push(h),setTimeout(function(){a.ea()
},this.ca)):this.L=Z
},K:function(h){var i=/^---destpub-to-parent---/;
"string"===typeof h&&i.test(h)&&(i=h.replace(i,"").split("|"),"canSetThirdPartyCookies"===i[0]&&(this.$="true"===i[1]?aa:Z,this.da=aa,this.p()),this.Fa.push(h))
...
},ua:function(a,h){return ad.Ra||!a||h-a>J.ha
}};
ad.Pa=K;
...
try{ad.X.K(function(h){K.K(h.data)
},K.I)
...
var visitor=visitor||Visitor.getInstance("B8D07FF4520E94C10A490D4C@AdobeOrg",{trackingServer:"cisco.sc.omtrdc.net",marketingCloudServer:"cisco.sc.omtrdc.net"});
 ...
 * @version   2.1.1
 */
(function(){function S(an){return typeof an==="function"||(typeof an==="object"&&an!==null)
}function M(an){return typeof an==="function"
}function K(an){return typeof an==="object"&&an!==null
}var j;
if(!Array.isArray){j=function(an){return Object.prototype.toString.call(an)==="[object Array]"
}
...
var aj={}.toString;
var x;
function V(ao,an){L[y]=ao;
L[y+1]=an;
y+=2;
if(y===2){H()
}}var U=V;
var X=(typeof window!=="undefined")?window:undefined;
var b=X||{};
var ab=b.MutationObserver||b.WebKitMutationObserver;
...
function ag(){var ao=process.nextTick;
var an=process.versions.node.match(/^(?:(\d+)\.)?(?:(\d+)\.)?(\*|\d+)$/);
if(Array.isArray(an)&&an[1]==="0"&&an[2]==="10"){ao=setImmediate
}return function(){ao(T)
}
}function C(){return function(){x(T)
}
}function F(){var ap=0;
var an=new ab(T);
var ao=document.createTextNode("");
an.observe(ao,{characterData:true});
return function(){ao.data=(ap=++ap%2)
}
}function Q(){var an=new MessageChannel();
an.port1.onmessage=T;
return function(){an.port2.postMessage(0)
}
}function l(){return function(){setTimeout(T,1)
}
}var L=new Array(1000);
function T(){for(var ao=0;
ao<y;
ao+=2){var ap=L[ao];
var an=L[ao+1];
ap(an);
...
}function G(){try{var ao=require;
var an=ao("vertx");
x=an.runOnLoop||an.runOnContext;
return C()
}catch(ap){return l()
}}var H;
if(t){H=ag()
...
}else{if(X===undefined&&typeof require==="function"){H=G()
}else{H=l()
}}}}function N(){}var m=void 0;
var u=1;
var ak=2;
var I=new J();
function E(){return new TypeError("You cannot resolve a promise with itself")
}function s(){return new TypeError("A promises callback cannot return that same promise.")
}function B(ao){try{return ao.then
}catch(an){I.error=an;
return I
}}function ac(ar,ap,ao,an){try{ar.call(ap,ao,an)
}catch(aq){return aq
}}function d(ap,an,ao){U(function(at){var ar=false;
var aq=ac(ao,an,function(au){if(ar){return
}ar=true;
if(an!==au){ai(at,au)
}else{ah(at,au)
}},function(au){if(ar){return
}ar=true;
aa(at,au)
},"Settle: "+(at._label||" unknown promise"));
if(!ar&&aq){ar=true;
aa(at,aq)
}},ap)
}function ad(ao,an){if(an._state===u){ah(ao,an._result)
}else{if(an._state===ak){aa(ao,an._result)
}else{P(an,undefined,function(ap){ai(ao,ap)
},function(ap){aa(ao,ap)
})
}}}function r(ap,an){if(an.constructor===ap.constructor){ad(ap,an)
}else{var ao=B(an);
if(ao===I){aa(ap,I.error)
}else{if(ao===undefined){ah(ap,an)
}else{if(M(ao)){d(ap,an,ao)
}else{ah(ap,an)
}}}}}function ai(ao,an){if(ao===an){aa(ao,E())
}else{if(S(an)){r(ao,an)
}else{ah(ao,an)
}}}function q(an){if(an._onerror){an._onerror(an._result)
}ae(an)
}function ah(ao,an){if(ao._state!==m){return
}ao._result=an;
ao._state=u;
if(ao._subscribers.length!==0){U(ae,ao)
}}function aa(ao,an){if(ao._state!==m){return
}ao._state=ak;
ao._result=an;
U(q,ao)
}function P(an,at,ar,aq){var ap=an._subscribers;
var ao=ap.length;
an._onerror=null;
ap[ao]=at;
ap[ao+u]=ar;
ap[ao+ak]=aq;
if(ao===0&&an._state){U(ae,an)
}}function ae(ar){var aq=ar._subscribers;
var an=ar._state;
if(aq.length===0){return
}var au,at,ap=ar._result;
for(var ao=0;
ao<aq.length;
ao+=3){au=aq[ao];
at=aq[ao+an];
...
}}ar._subscribers.length=0
}function J(){this.error=null
}var i=new J();
function am(ap,an){try{return ap(an)
}catch(ao){i.error=ao;
return i
}}function D(au,aw,at,ap){var an=M(at),ar,aq,av,ao;
if(an){ar=am(at,ap);
if(ar===i){ao=true;
aq=ar.error;
ar=null
...
av=true
}if(aw._state!==m){}else{if(an&&av){ai(aw,ar)
}else{if(ao){aa(aw,aq)
}else{if(au===u){ah(aw,ar)
}else{if(au===ak){aa(aw,ar)
}}}}}}function af(ar,aq){try{aq(function an(at){ai(ar,at)
},function ap(at){aa(ar,at)
})
}catch(ao){aa(ar,ao)
}}function p(ao,an){var ap=this;
ap._instanceConstructor=ao;
ap.promise=new ao(N);
if(ap._validateInput(an)){ap._input=an;
ap.length=an.length;
ap._remaining=an.length;
ap._init();
if(ap.length===0){ah(ap.promise,ap._result)
}else{ap.length=ap.length||0;
ap._enumerate();
if(ap._remaining===0){ah(ap.promise,ap._result)
}}}else{aa(ap.promise,ap._validationError())
}}p.prototype._validateInput=function(an){return w(an)
};
...
var W=p;
p.prototype._enumerate=function(){var ar=this;
var ap=ar.length;
var aq=ar.promise;
var an=ar._input;
for(var ao=0;
aq._state===m&&ao<ap;
ao++){ar._eachEntry(an[ao],ao)
}};
p.prototype._eachEntry=function(ao,an){var aq=this;
var ap=aq._instanceConstructor;
if(K(ao)){if(ao.constructor===ap&&ao._state!==m){ao._onerror=null;
aq._settledAt(ao._state,an,ao._result)
}else{aq._willSettleAt(ap.resolve(ao),an)
}}else{aq._remaining--;
aq._result[an]=ao
}};
p.prototype._settledAt=function(ap,an,ao){var ar=this;
var aq=ar.promise;
if(aq._state===m){ar._remaining--;
if(ap===ak){aa(aq,ao)
}else{ar._result[an]=ao
}}if(ar._remaining===0){ah(aq,ar._result)
}};
p.prototype._willSettleAt=function(ao,an){var ap=this;
P(ao,undefined,function(aq){ap._settledAt(u,an,aq)
},function(aq){ap._settledAt(ak,an,aq)
})
};
function o(an){return new W(this,an).promise
}var e=o;
function a(an){var au=this;
var at=new au(N);
if(!w(an)){aa(at,new TypeError("You must pass an array to race."));
return at
}var ap=an.length;
function ar(av){ai(at,av)
}function aq(av){aa(at,av)
}for(var ao=0;
at._state===m&&ao<ap;
ao++){P(au.resolve(an[ao]),undefined,ar,aq)
}return at
}var A=a;
function Y(an){var ap=this;
if(an&&typeof an==="object"&&an.constructor===ap){return an
}var ao=new ap(N);
ai(ao,an);
return ao
}var O=Y;
function v(an){var ap=this;
var ao=new ap(N);
aa(ao,an);
return ao
}var al=v;
...
Z.resolve=O;
Z.reject=al;
Z.prototype={constructor:Z,then:function(ar,aq){var ao=this;
var ap=ao._state;
if(ap===u&&!ar||ap===ak&&!aq){return this
}var au=new this.constructor(N);
var an=ao._result;
if(ap){var at=arguments[ap-1];
U(function(){D(ap,au,at,an)
})
}else{P(ao,au,ar,aq)
}return au
},"catch":function(an){return this.then(null,an)
}};
function c(){var an;
if(typeof global!=="undefined"){an=global
}else{if(typeof self!=="undefined"){an=self
}else{try{an=Function("return this")()
}catch(ap){throw new Error("polyfill failed because global object is unavailable in this environment")
}}}var ao=an.Promise;
if(ao&&Object.prototype.toString.call(ao.resolve())==="[object Promise]"&&!ao.cast){return
}an.Promise=z
}var k=c;
var f={Promise:z,polyfill:k};
 ...
 * MIT License
 */
(function(Q,c,l){var f=[];
var p=[];
var U={_version:"3.5.0",_config:{classPrefix:"",enableClasses:true,enableJSClass:true,usePrefixes:true},_q:[],on:function(ad,e){var i=this;
setTimeout(function(){e(i[ad])
},0)
},addTest:function(i,ad,e){p.push({name:i,fn:ad,options:e})
},addAsyncTest:function(e){p.push({name:null,fn:e})
}};
var J=function(){};
J.prototype=U;
J=new J();
...
!*/
J.addTest("applicationcache","applicationCache" in Q);
/*!
{
...
!*/
J.addTest("geolocation","geolocation" in navigator);
/*!
{
  "name": "History API",
  "property": "history",
...
!*/
J.addTest("history",function(){var e=navigator.userAgent;
if((e.indexOf("Android 2.")!==-1||(e.indexOf("Android 4.0")!==-1))&&e.indexOf("Mobile Safari")!==-1&&e.indexOf("Chrome")===-1&&e.indexOf("Windows Phone")===-1&&location.protocol!=="file:"){return false
}return(Q.history&&"pushState" in Q.history)
});
/*!
{
  "name": "postMessage",
...
!*/
J.addTest("postmessage","postMessage" in Q);
/*!
{
  "name": "SVG",
  "property": "svg",
...
!*/
J.addTest("svg",!!c.createElementNS&&!!c.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect);
/*!
{
...
!*/
var N=false;
try{N="WebSocket" in Q&&Q.WebSocket.CLOSING===2
}catch(X){}J.addTest("websockets",N);
/*!
{
  "name": "Local Storage",
...
!*/
J.addTest("localstorage",function(){var i="modernizr";
try{localStorage.setItem(i,i);
...
!*/
J.addTest("sessionstorage",function(){var i="modernizr";
try{sessionStorage.setItem(i,i);
...
!*/
J.addTest("websqldatabase","openDatabase" in Q);
/*!
{
  "name": "Web Workers",
  "property": "webworkers",
...
!*/
J.addTest("webworkers","Worker" in Q);
var o=(U._config.usePrefixes?" -webkit- -moz- -o- -ms- ".split(" "):["",""]);
U._prefixes=o;
function E(i,e){return typeof i===e
}function aa(){var af;
var ag;
var ad;
var e;
...
var ae;
var ai;
for(var ah in p){if(p.hasOwnProperty(ah)){af=[];
ag=p[ah];
if(ag.name){af.push(ag.name.toLowerCase());
if(ag.options&&ag.options.aliases&&ag.options.aliases.length){for(ad=0;
ad<ag.options.aliases.length;
ad++){af.push(ag.options.aliases[ad].toLowerCase())
}}}e=E(ag.fn,"function")?ag.fn():ag.fn;
for(i=0;
i<af.length;
i++){ae=af[i];
ai=ae.split(".");
if(ai.length===1){J[ai[0]]=e
}else{if(J[ai[0]]&&!(J[ai[0]] instanceof Boolean)){J[ai[0]]=new Boolean(J[ai[0]])
}J[ai[0]][ai[1]]=e
}f.push((e?"":"no-")+ai.join("-"))
}}}}var ac=c.documentElement;
var a=ac.nodeName.toLowerCase()==="svg";
function b(ad){var ae=ac.className;
var i=J._config.classPrefix||"";
if(a){ae=ae.baseVal
}if(J._config.enableJSClass){var e=new RegExp("(^|\\s)"+i+"no-js(\\s|$)");
ae=ae.replace(e,"$1"+i+"js$2")
}if(J._config.enableClasses){ae+=" "+i+ad.join(" "+i);
if(a){ac.className.baseVal=ae
}else{ac.className=ae
}}}var M;
if(!a){(function(al,an){var ah="3.7.3";
var ae=al.html5||{};
var ai=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i;
var ad=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i;
var at;
var aj="_html5shiv";
var e=0;
var ap={};
var af;
(function(){try{var aw=an.createElement("a");
aw.innerHTML="<xyz></xyz>";
at=("hidden" in aw);
af=aw.childNodes.length==1||(function(){(an.createElement)("a");
var ay=an.createDocumentFragment();
return(typeof ay.cloneNode=="undefined"||typeof ay.createDocumentFragment=="undefined"||typeof ay.createElement=="undefined")
}())
}catch(ax){at=true;
af=true
}}());
function ag(aw,ay){var az=aw.createElement("p"),ax=aw.getElementsByTagName("head")[0]||aw.documentElement;
az.innerHTML="x<style>"+ay+"</style>";
return ax.insertBefore(az.lastChild,ax.firstChild)
}function am(){var aw=ak.elements;
return typeof aw=="string"?aw.split(" "):aw
}function aq(aw,ax){var ay=ak.elements;
if(typeof ay!="string"){ay=ay.join(" ")
}if(typeof aw!="string"){aw=aw.join(" ")
}ak.elements=ay+" "+aw;
i(ax)
}function ar(aw){var ax=ap[aw[aj]];
if(!ax){ax={};
e++;
aw[aj]=e;
ap[e]=ax
}return ax
}function ao(az,aw,ay){if(!aw){aw=an
}if(af){return aw.createElement(az)
}if(!ay){ay=ar(aw)
}var ax;
if(ay.cache[az]){ax=ay.cache[az].cloneNode()
}else{if(ad.test(az)){ax=(ay.cache[az]=ay.createElem(az)).cloneNode()
}else{ax=ay.createElem(az)
}}return ax.canHaveChildren&&!ai.test(az)&&!ax.tagUrn?ay.frag.appendChild(ax):ax
}function au(ay,aA){if(!ay){ay=an
}if(af){return ay.createDocumentFragment()
}aA=aA||ar(ay);
var aB=aA.frag.cloneNode(),az=0,ax=am(),aw=ax.length;
for(;
az<aw;
az++){aB.createElement(ax[az])
}return aB
}function av(aw,ax){if(!ax.cache){ax.cache={};
ax.createElem=aw.createElement;
ax.createFrag=aw.createDocumentFragment;
ax.frag=ax.createFrag()
}aw.createElement=function(ay){if(!ak.shivMethods){return ax.createElem(ay)
}return ao(ay,aw,ax)
};
aw.createDocumentFragment=Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+am().join().replace(/[\w\-:]+/g,function(ay){ax.createElem(ay);
ax.frag.createElement(ay);
return'c("'+ay+'")'
})+");return n}")(ak,ax.frag)
}function i(aw){if(!aw){aw=an
}var ax=ar(aw);
if(ak.shivCSS&&!at&&!ax.hasCSS){ax.hasCSS=!!ag(aw,"article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")
}if(!af){av(aw,ax)
}return aw
}var ak={elements:ae.elements||"abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output picture progress section summary template time video",version:ah,shivCSS:(ae.shivCSS!==false),supportsUnknownElements:af,shivMethods:(ae.shivMethods!==false),type:"default",shivDocument:i,createElement:ao,createDocumentFragment:au,addElements:aq};
al.html5=ak;
i(an);
if(typeof module=="object"&&module.exports){module.exports=ak
}}(typeof Q!=="undefined"?Q:this,c))
}var m="Moz O ms Webkit";
var Y=(U._config.usePrefixes?m.toLowerCase().split(" "):[]);
U._domPrefixes=Y;
var K;
(function(){var e=({}).hasOwnProperty;
if(!E(e,"undefined")&&!E(e.call,"undefined")){K=function(i,ad){return e.call(i,ad)
}
}else{K=function(i,ad){return((ad in i)&&E(i.constructor.prototype[ad],"undefined"))
}
}})();
U._l={};
U.on=function(i,e){if(!this._l[i]){this._l[i]=[]
}this._l[i].push(e);
if(J.hasOwnProperty(i)){setTimeout(function(){J._trigger(i,J[i])
},0)
}};
U._trigger=function(ad,i){if(!this._l[ad]){return
}var e=this._l[ad];
setTimeout(function(){var af,ae;
for(af=0;
af<e.length;
af++){ae=e[af];
ae(i)
...
function D(i,af){if(typeof i=="object"){for(var e in i){if(K(i,e)){D(e,i[e])
}}}else{i=i.toLowerCase();
var ae=i.split(".");
var ad=J[ae[0]];
if(ae.length==2){ad=ad[ae[1]]
}if(typeof ad!="undefined"){return J
}af=typeof af=="function"?af():af;
if(ae.length==1){J[ae[0]]=af
}else{if(J[ae[0]]&&!(J[ae[0]] instanceof Boolean)){J[ae[0]]=new Boolean(J[ae[0]])
}J[ae[0]][ae[1]]=af
}b([(!!af&&af!=false?"":"no-")+ae.join("-")]);
J._trigger(i,af)
}return J
}J._q.push(function(){U.addTest=D
});
function H(){if(typeof c.createElement!=="function"){return c.createElement(arguments[0])
}else{if(a){return c.createElementNS.call(c,"http://www.w3.org/2000/svg",arguments[0])
}else{return c.createElement.apply(c,arguments)
}}}var z=(function(){var i=!("onblur" in c.documentElement);
function e(ad,af){var ae;
if(!ad){return false
}if(!af||typeof af==="string"){af=H(af||"div")
}ad="on"+ad;
ae=ad in af;
if(!ae&&i){if(!af.setAttribute){af=H("div")
}af.setAttribute(ad,"");
ae=typeof af[ad]==="function";
if(af[ad]!==l){af[ad]=l
}af.removeAttribute(ad)
}return ae
}return e
})();
U.hasEvent=z;
...
!*/
J.addTest("hashchange",function(){if(z("hashchange",Q)===false){return false
}return(c.documentMode===l||c.documentMode>7)
});
/*!
{
...
!*/
J.addTest("audio",function(){var ad=H("audio");
var i=false;
try{i=!!ad.canPlayType;
if(i){i=new Boolean(i);
i.ogg=ad.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/,"");
i.mp3=ad.canPlayType('audio/mpeg; codecs="mp3"').replace(/^no$/,"");
i.opus=ad.canPlayType('audio/ogg; codecs="opus"')||ad.canPlayType('audio/webm; codecs="opus"').replace(/^no$/,"");
i.wav=ad.canPlayType('audio/wav; codecs="1"').replace(/^no$/,"");
i.m4a=(ad.canPlayType("audio/x-m4a;")||ad.canPlayType("audio/aac;")).replace(/^no$/,"")
}}catch(ae){}return i
});
/*!
{
...
!*/
J.addTest("canvas",function(){var e=H("canvas");
...
!*/
J.addTest("canvastext",function(){if(J.canvas===false){return false
}return typeof H("canvas").getContext("2d").fillText=="function"
});
/*!
{
  "name": "HTML Imports",
...
!*/
D("htmlimports","import" in H("link"));
/*!
{
  "name": "HTML5 Video",
  "property": "video",
...
!*/
J.addTest("video",function(){var ad=H("video");
var i=false;
try{i=!!ad.canPlayType;
if(i){i=new Boolean(i);
i.ogg=ad.canPlayType('video/ogg; codecs="theora"').replace(/^no$/,"");
i.h264=ad.canPlayType('video/mp4; codecs="avc1.42E01E"').replace(/^no$/,"");
i.webm=ad.canPlayType('video/webm; codecs="vp8, vorbis"').replace(/^no$/,"");
i.vp9=ad.canPlayType('video/webm; codecs="vp9"').replace(/^no$/,"");
i.hls=ad.canPlayType('application/x-mpegURL; codecs="avc1.42E01E"').replace(/^no$/,"")
}}catch(ae){}return i
});
/*!
{
...
!*/
J.addTest("webgl",function(){var i=H("canvas");
var e="probablySupportsContext" in i?"probablySupportsContext":"supportsContext";
if(e in i){return i[e]("webgl")||i[e]("experimental-webgl")
}return"WebGLRenderingContext" in Q
});
/*!
{
  "name": "CSS Gradients",
...
!*/
J.addTest("cssgradients",function(){var ai="background-image:";
var ah="gradient(linear,left top,right bottom,from(#9f9),to(white));";
var ae="";
var aj;
for(var ad=0,e=o.length-1;
ad<e;
ad++){aj=(ad===0?"to ":"");
ae+=ai+o[ad]+"linear-gradient("+aj+"left top, #9f9, white);"
}if(J._config.usePrefixes){ae+=ai+"-webkit-"+ah
}var ag=H("a");
var af=ag.style;
af.cssText=ae;
return(""+af.backgroundImage).indexOf("gradient")>-1
});
/*!
{
...
!*/
J.addTest("multiplebgs",function(){var e=H("a").style;
...
!*/
J.addTest("opacity",function(){var e=H("a").style;
e.cssText=o.join("opacity:.55;");
...
!*/
J.addTest("rgba",function(){var e=H("a").style;
...
!*/
J.addTest("inlinesvg",function(){var e=H("div");
e.innerHTML="<svg/>";
return(typeof SVGRect!="undefined"&&e.firstChild&&e.firstChild.namespaceURI)=="http://www.w3.org/2000/svg"
});
function A(e){return e.replace(/([a-z])-([a-z])/g,function(ae,ad,i){return ad+i.toUpperCase()
}).replace(/^-/,"")
}var ab=H("input");
/*!
{
...
!*/
var R="autocomplete autofocus list placeholder max min multiple pattern required step".split(" ");
var j={};
J.input=(function(ae){for(var ad=0,e=ae.length;
ad<e;
ad++){j[ae[ad]]=!!(ae[ad] in ab)
}if(j.list){j.list=!!(H("datalist")&&Q.HTMLDataListElement)
}return j
})(R);
/*!
{
...
var u={};
J.inputtypes=(function(ag){var e=ag.length;
var ae="1)";
var ai;
var ah;
var ad;
for(var af=0;
af<e;
af++){ab.setAttribute("type",ai=ag[af]);
ad=ab.type!=="text"&&"style" in ab;
if(ad){ab.value=ae;
ab.style.cssText="position:absolute;visibility:hidden;";
if(/^range$/.test(ai)&&ab.style.WebkitAppearance!==l){ac.appendChild(ab);
ah=c.defaultView;
ad=ah.getComputedStyle&&ah.getComputedStyle(ab,null).WebkitAppearance!=="textfield"&&(ab.offsetHeight!==0);
ac.removeChild(ab)
}else{if(/^(search|tel)$/.test(ai)){}else{if(/^(url|email)$/.test(ai)){ad=ab.checkValidity&&ab.checkValidity()===false
}else{ad=ab.value!=ae
}}}}u[ag[af]]=!!ad
}return u
})(s);
function I(i,e){return !!~(""+i).indexOf(e)
}
/*!
{
...
!*/
J.addTest("hsla",function(){var e=H("a").style;
e.cssText="background-color:hsla(120,40%,100%,.5)";
return I(e.backgroundColor,"rgba")||I(e.backgroundColor,"hsla")
});
/*!
{
  "name": "CSS Supports",
...
!*/
var G="CSS" in Q&&"supports" in Q.CSS;
var B="supportsCSS" in Q;
J.addTest("supports",G||B);
var y=({}).toString;
/*!
{
  "name": "SVG clip paths",
...
!*/
J.addTest("svgclippaths",function(){return !!c.createElementNS&&/SVGClipPath/.test(y.call(c.createElementNS("http://www.w3.org/2000/svg","clipPath")))
});
/*!
{
...
!*/
J.addTest("smil",function(){return !!c.createElementNS&&/SVGAnimate/.test(y.call(c.createElementNS("http://www.w3.org/2000/svg","animate")))
});
function Z(){var e=c.body;
if(!e){e=H(a?"svg":"body");
e.fake=true
}return e
}function r(ai,al,ad,ak){var aj="modernizr";
var i;
var ah;
var ae;
var af;
var e=H("div");
var ag=Z();
if(parseInt(ad,10)){while(ad--){ae=H("div");
ae.id=ak?ak[ad]:aj+(ad+1);
e.appendChild(ae)
}}i=H("style");
i.type="text/css";
i.id="s"+aj;
(!ag.fake?e:ag).appendChild(i);
ag.appendChild(e);
if(i.styleSheet){i.styleSheet.cssText=ai
}else{i.appendChild(c.createTextNode(ai))
}e.id=aj;
if(ag.fake){ag.style.background="";
ag.style.overflow="hidden";
af=ac.style.overflow;
ac.style.overflow="hidden";
ac.appendChild(ag)
}ah=al(e,ai);
if(ag.fake){ag.parentNode.removeChild(ag);
ac.style.overflow=af;
ac.offsetHeight
}else{e.parentNode.removeChild(e)
}return !!ah
}var k=(function(){var e=Q.matchMedia||Q.msMatchMedia;
if(e){return function(ad){var i=e(ad);
return i&&i.matches||false
}
}return function(ad){var i=false;
r("@media "+ad+" { #modernizr { position: absolute; } }",function(ae){i=(Q.getComputedStyle?Q.getComputedStyle(ae,null):ae.currentStyle).position=="absolute"
});
return i
}
})();
...
!*/
J.addTest("mediaqueries",k("only all"));
var x=U.testStyles=r;
/*!
{
  "name": "@font-face",
  "property": "fontface",
...
!*/
var L=(function(){var i=navigator.userAgent;
var e=i.match(/w(eb)?osbrowser/gi);
var ad=i.match(/windows phone/gi)&&i.match(/iemobile\/([0-9])+/gi)&&parseFloat(RegExp.$1)>=9;
return e||ad
}());
if(L){J.addTest("fontface",false)
}else{x('@font-face {font-family:"font";src:url("https://")}',function(af,ag){var ae=c.getElementById("smodernizr");
var i=ae.sheet||ae.styleSheet;
var ad=i?(i.cssRules&&i.cssRules[0]?i.cssRules[0].cssText:i.cssText||""):"";
var e=/src/i.test(ad)&&ad.indexOf(ag.split(" ")[0])===0;
J.addTest("fontface",e)
})
}
/*!
{
...
!*/
x('#modernizr{font:0/0 a}#modernizr:after{content:":)";visibility:hidden;font:7px/1 a}',function(e){J.addTest("generatedcontent",e.offsetHeight>=6)
});
var T=(U._config.usePrefixes?m.split(" "):[]);
U._cssomPrefixes=T;
var d=function(ai){var ae=o.length;
var ag=Q.CSSRule;
var ah;
if(typeof ag==="undefined"){return l
}if(!ai){return false
}ai=ai.replace(/^@/,"");
ah=ai.replace(/-/g,"_").toUpperCase()+"_RULE";
if(ah in ag){return"@"+ai
}for(var e=0;
e<ae;
e++){var af=o[e];
var ad=af.toUpperCase()+"_"+ah;
if(ad in ag){return"@-"+af.toLowerCase()+"-"+ai
}}return false
};
U.atRule=d;
function C(e,i){return function(){return e.apply(i,arguments)
}
}function w(ad,ag,af){var ae;
for(var e in ad){if(ad[e] in ag){if(af===false){return ad[e]
}ae=ag[ad[e]];
if(E(ae,"function")){return C(ae,af||ag)
}return ae
}}return false
}var W={elem:H("modernizr")};
J._q.push(function(){delete W.elem
});
var S={style:W.elem.style};
J._q.unshift(function(){delete S.style
});
function h(e){return e.replace(/([A-Z])/g,function(ad,i){return"-"+i.toLowerCase()
}).replace(/^ms-/,"-ms-")
}function t(ad,ae,ag){var e;
if("getComputedStyle" in Q){e=getComputedStyle.call(Q,ad,ae);
var i=Q.console;
if(e!==null){if(ag){e=e.getPropertyValue(ag)
}}else{if(i){var af=i.error?"error":"log";
i[af].call(i,"getComputedStyle returning null, its possible modernizr test results are inaccurate")
}}}else{e=!ae&&ad.currentStyle&&ad.currentStyle[ag]
}return e
}function F(ad,ae){var e=ad.length;
if("CSS" in Q&&"supports" in Q.CSS){while(e--){if(Q.CSS.supports(h(ad[e]),ae)){return true
}}return false
}else{if("CSSSupportsRule" in Q){var af=[];
while(e--){af.push("("+h(ad[e])+":"+ae+")")
}af=af.join(" or ");
return r("@supports ("+af+") { #modernizr { position: absolute; } }",function(i){return t(i,null,"position")=="absolute"
})
}}return l
}function P(ak,ag,an,al){al=E(al,"undefined")?false:al;
if(!E(an,"undefined")){var ap=F(ak,an);
if(!E(ap,"undefined")){return ap
}}var ao,ah,ad,af,am;
var ae=["modernizr","tspan","samp"];
while(!S.style&&ae.length){ao=true;
S.modElem=H(ae.shift());
S.style=S.modElem.style
}function ai(){if(ao){delete S.style;
delete S.modElem
}}ad=ak.length;
for(ah=0;
ah<ad;
...
am=S.style[af];
if(I(af,"-")){af=A(af)
}if(S.style[af]!==l){if(!al&&!E(an,"undefined")){try{S.style[af]=an
}catch(aj){}if(S.style[af]!=am){ai();
return ag=="pfx"?af:true
}}else{ai();
return ag=="pfx"?af:true
}}}ai();
return false
}var g=U.testProp=function(ad,i,e){return P([ad],l,i,e)
};
function q(ah,e,ae,af,ag){var i=ah.charAt(0).toUpperCase()+ah.slice(1),ad=(ah+" "+T.join(i+" ")+i).split(" ");
if(E(e,"string")||E(e,"undefined")){return P(ad,e,af,ag)
}else{ad=(ah+" "+(Y).join(i+" ")+i).split(" ");
return w(ad,e,ae)
}}U.testAllProps=q;
var v=U.prefixed=function(ad,i,e){if(ad.indexOf("@")===0){return d(ad)
}if(ad.indexOf("-")!=-1){ad=A(ad)
}if(!i){return q(ad,"pfx")
}else{return q(ad,i,e)
}};
/*!
{
  "name": "IndexedDB",
...
!*/
J.addAsyncTest(function(){var ad;
try{ad=v("indexedDB",Q)
}catch(af){}if(!!ad){var i="modernizr-"+Math.random();
var ae=ad.open(i);
ae.onerror=function(){if(ae.error&&ae.error.name==="InvalidStateError"){D("indexeddb",false)
}else{D("indexeddb",true);
O(ad,i)
}};
ae.onsuccess=function(){D("indexeddb",true);
O(ad,i)
}
}else{D("indexeddb",false)
}});
function O(i,e){var ad=i.deleteDatabase(e);
ad.onsuccess=function(){D("indexeddb.deletedatabase",true)
};
ad.onerror=function(){D("indexeddb.deletedatabase",false)
}
}
/*!
{
...
!*/
J.addTest("speechrecognition",!!v("SpeechRecognition",Q));
function n(ad,e,i){return q(ad,l,l,e,i)
}U.testAllProps=n;
/*!
{
  "name": "CSS Animations",
...
!*/
J.addTest("cssanimations",n("animationName","a",true));
/*!
{
...
!*/
J.addTest("backgroundsize",n("backgroundSize","100%",true));
/*!
{
  "name": "Border Image",
...
!*/
J.addTest("borderimage",n("borderImage","url() 1",true));
/*!
{
  "name": "Border Radius",
...
!*/
J.addTest("borderradius",n("borderRadius","0px",true));
/*!
{
  "name": "Box Shadow",
  "property": "boxshadow",
...
!*/
J.addTest("boxshadow",n("boxShadow","1px 1px",true));
/*!
{
  "name": "CSS Columns",
  "property": "csscolumns",
...
!*/
(function(){J.addTest("csscolumns",function(){var i=false;
var ah=n("columnCount");
try{i=!!ah;
if(i){i=new Boolean(i)
}}catch(ag){}return i
});
var ae=["Width","Span","Fill","Gap","Rule","RuleColor","RuleStyle","RuleWidth","BreakBefore","BreakAfter","BreakInside"];
var e,af;
for(var ad=0;
ad<ae.length;
ad++){e=ae[ad].toLowerCase();
af=n("column"+ae[ad]);
if(e==="breakbefore"||e==="breakafter"||e=="breakinside"){af=af||n(ae[ad])
}J.addTest("csscolumns."+e,af)
}})();
/*!
{
  "name": "Flexbox",
...
!*/
J.addTest("flexbox",n("flexBasis","1px",true));
/*!
{
  "name": "Flexbox (legacy)",
...
!*/
J.addTest("flexboxlegacy",n("boxDirection","reverse",true));
/*!
{
...
!*/
J.addTest("cssreflections",n("boxReflect","above",true));
/*!
{
  "name": "CSS Transforms",
...
!*/
J.addTest("csstransforms",function(){return navigator.userAgent.indexOf("Android 2.")===-1&&n("transform","scale(1)",true)
});
/*!
{
...
!*/
J.addTest("csstransforms3d",function(){var i=!!n("perspective","1px",true);
var e=J._config.usePrefixes;
if(i&&(!e||"webkitPerspective" in ac.style)){var ad;
var ae="#modernizr{width:0;height:0}";
if(J.supports){ad="@supports (perspective: 1px)"
}else{ad="@media (transform-3d)";
if(e){ad+=",(-webkit-transform-3d)"
}}ad+="{#modernizr{width:7px;height:18px;margin:0;padding:0;border:0}}";
x(ae+ad,function(af){i=af.offsetWidth===7&&af.offsetHeight===18
})
}return i
});
/*!
...
!*/
J.addTest("csstransitions",n("transition","all",true));
aa();
b(f);
delete U.addTest;
...
Modernizr.addTest("compatibilitymode",function(){var a=/compatible\; MSIE 7.(\d+)?.*\; Trident\/\d\.\d\;/.exec(navigator.userAgent),b=false;
if(a){if(a[0].length>0){b=true
}}return b
});
Modernizr.addTest("touch",function(){var a=false;
var d={};
var b=document.documentElement;
b.className=b.className.replace(/(^|\s)no-touch(\s|$)/,"");
var f=Modernizr.prefixed("MaxTouchPoints",navigator);
if(f>1){a=true
}if(!a){if(("ontouchstart" in window)||window.DocumentTouch&&document instanceof DocumentTouch){a=true
}else{Modernizr.testStyles(["@media (",Modernizr._prefixes.join("touch-enabled),("),"modernizr",")","{#modernizr{top:9px;position:absolute}}"].join(""),function(g){a=g.offsetTop===9
})
}}function e(){d.isWindows=false;
d.isWindowsPhone=false;
d.isHybridDevice=false;
if(navigator.userAgent.indexOf("Windows")!==-1){d.isWindows=true;
d.isWindowsPhone=navigator.userAgent.indexOf("Windows Phone")!==-1?true:false
}if(d.isWindows&&!d.isWindowsPhone){d.isHybridDevice=a
}return d
}var c=new e();
if(c.isHybridDevice){a=false
}return a
});
jQuery(document).ready(function(){Modernizr.addTest("megamenu",function(){var mm=true;
if(document.body.className.match("cec-login")||document.body.className.match("cdc-login")||document.body.className.match("fw-satellite")){mm=false
}return mm
});
var isIE=(navigator.userAgent.indexOf("MSIE")!==-1||navigator.appVersion.indexOf("Trident/")>0);
if(isIE){var docRoot=document.documentElement;
Modernizr.ie11=false;
Modernizr.ie10=false;
Modernizr.ie9=false;
Modernizr.ie8=false;
Modernizr.ie7=false;
Modernizr.ielt12=true;
...
if(docRoot.className.indexOf("ie ")==-1){Modernizr.addTest("ie",function(){var addedClasses=" gt-ie9 gt-ie8 gt-ie7 gt-ie6 ";
if(!!navigator.userAgent.match(/Trident.*rv\:11\./)){docRoot.setAttribute("id","ie11");
...
/*@cc_on!@*/
false&&document.documentMode===10){docRoot.setAttribute("id","ie10");
...
}else{if(docRoot.getAttribute("id")!=undefined){var elemId=docRoot.getAttribute("id");
switch(elemId){case"ie9":Modernizr.ie9=true;
Modernizr.ielt11=true;
Modernizr.ielt10=true;
Modernizr.iegt8=true;
Modernizr.iegt7=true;
break;
case"ie8":Modernizr.ie8=true;
Modernizr.ielt11=true;
Modernizr.ielt10=true;
Modernizr.ielt9=true;
Modernizr.iegt7=true;
break;
case"ie7":Modernizr.ie7=true;
Modernizr.ielt11=true;
Modernizr.ielt10=true;
Modernizr.ielt9=true;
...
(function(k,d){var i=k.document,c=i.documentElement,b="overthrow-enabled",n="ontouchmove" in i,e="WebkitOverflowScrolling" in c.style||(!n&&k.screen.width>1200)||(function(){var p=k.navigator.userAgent,o=p.match(/AppleWebKit\/([0-9]+)/),r=o&&o[1],q=o&&r>=534;
return(p.match(/Android ([0-9]+)/)&&RegExp.$1>=3&&q||p.match(/ Version\/([0-9]+)/)&&RegExp.$1>=0&&k.blackberry&&q||p.indexOf(/PlayBook/)>-1&&RegExp.$1>=0&&q||p.match(/Fennec\/([0-9]+)/)&&RegExp.$1>=4||p.match(/wOSBrowser\/([0-9]+)/)&&RegExp.$1>=233&&q||p.match(/NokiaBrowser\/([0-9\.]+)/)&&parseFloat(RegExp.$1)===7.3&&o&&r>=533)
})(),j=function(p,o,r,q){return r*((p=p/q-1)*p*p+1)+o
},h=false,g,m=function(r,x){var t=0,v=r.scrollLeft,w=r.scrollTop,q={top:"+0",left:"+0",duration:100,easing:k.overthrow.easing},u,p;
if(x){for(var s in q){if(x[s]!==d){q[s]=x[s]
}}}if(typeof q.left==="string"){q.left=parseFloat(q.left);
u=q.left+v
}else{u=q.left;
q.left=q.left-v
}if(typeof q.top==="string"){q.top=parseFloat(q.top);
p=q.top+w
}else{p=q.top;
q.top=q.top-w
}g=setInterval(function(){if(t++<q.duration){r.scrollLeft=q.easing(t,v,q.left,q.duration);
r.scrollTop=q.easing(t,w,q.top,q.duration)
}else{if(u!==r.scrollLeft){r.scrollLeft=u
}if(p!==r.scrollTop){r.scrollTop=p
}l()
}},1);
return{top:p,left:u,duration:q.duration,easing:q.easing}
},a=function(p,o){return !o&&p.className&&p.className.indexOf("overthrow")>-1&&p||a(p.parentNode)
},l=function(){clearInterval(g)
},f=function(){if(h){return
}h=true;
if(e||n){c.className+=" "+b
}k.overthrow.forget=function(){c.className=c.className.replace(b,"");
if(i.removeEventListener){i.removeEventListener("touchstart",p,false)
}k.overthrow.easing=j;
h=false
};
if(e||!n){return
}var s,w=[],o=[],v,y,x=function(){w=[];
v=null
},t=function(){o=[];
y=null
},r=function(){var C=(w[0]-w[w.length-1])*8,B=(o[0]-o[o.length-1])*8,A=Math.max(Math.abs(B),Math.abs(C))/8;
C=(C>0?"+":"")+C;
B=(B>0?"+":"")+B;
if(!isNaN(A)&&A>0&&(Math.abs(B)>80||Math.abs(C)>80)){m(s,{left:B,top:C,duration:A})
}},u,q=function(C){u=s.querySelectorAll("textarea, input");
for(var B=0,A=u.length;
B<A;
B++){u[B].style.pointerEvents=C
}},z=function(B,C){if(i.createEvent){var D=(!C||C===d)&&s.parentNode||s.touchchild||s,A;
if(D!==s){A=i.createEvent("HTMLEvents");
...
t();
s=a(I.target);
if(!s||s===c||I.touches.length>1){return
}q("none");
var J=I,A=s.scrollTop,E=s.scrollLeft,K=s.offsetHeight,B=s.offsetWidth,F=I.touches[0].pageY,H=I.touches[0].pageX,L=s.scrollHeight,G=s.scrollWidth,C=function(P){var M=A+F-P.touches[0].pageY,N=E+H-P.touches[0].pageX,Q=M>=(w.length?w[0]:0),O=N>=(o.length?o[0]:0);
if((M>0&&M<L-K)||(N>0&&N<G-B)){P.preventDefault()
}else{z(J)
}if(v&&Q!==v){x()
}if(y&&O!==y){t()
}v=Q;
...
q("auto");
setTimeout(function(){q("none")
},450);
s.removeEventListener("touchmove",C,false);
s.removeEventListener("touchend",D,false)
};
s.addEventListener("touchmove",C,false);
s.addEventListener("touchend",D,false)
};
i.addEventListener("touchstart",p,false)
};
k.overthrow={set:f,forget:function(){},easing:j,toss:m,intercept:l,closest:a,support:e?"native":n&&"polyfilled"||"none"};
f()
})(this);
!function(d,c){"object"==typeof exports?module.exports=c():"function"==typeof define&&define.amd?define(c):d.Spinner=c()
}(this,function(){function F(f,e){var h,g=document.createElement(f||"div");
for(h in e){g[h]=e[h]
}return g
}function E(e){for(var d=1,f=arguments.length;
f>d;
d++){e.appendChild(arguments[d])
}return e
}function D(H,G,p,o){var n=["opacity",G,~~(100*H),p,o].join("-"),m=0.01+p/o*100,l=Math.max(1-(1-H)/G*(100-m),H),k=v.substring(0,v.indexOf("Animation")).toLowerCase(),j=k&&"-"+k+"-"||"";
return t[n]||(s.insertRule("@"+j+"keyframes "+n+"{0%{opacity:"+l+"}"+m+"%{opacity:"+H+"}"+(m+0.01)+"%{opacity:1}"+(m+G)%100+"%{opacity:"+H+"}100%{opacity:"+l+"}}",s.cssRules.length),t[n]=1),n
}function C(g,f){var j,i,h=g.style;
for(f=f.charAt(0).toUpperCase()+f.slice(1),i=0;
i<u.length;
i++){if(j=u[i]+f,void 0!==h[j]){return j
}}return void 0!==h[f]?f:void 0
}function B(e,d){for(var f in d){e.style[C(e,f)||f]=d[f]
}return e
}function A(f){for(var e=1;
e<arguments.length;
e++){var h=arguments[e];
for(var g in h){void 0===f[g]&&(f[g]=h[g])
}}return f
...
}function x(b){return"undefined"==typeof this?new x(b):(this.opts=A(b||{},x.defaults,r),void 0)
}function w(){function a(d,e){return F("<"+d+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',e)
}s.addRule(".spin-vml","behavior:url(#default#VML)"),x.prototype.lines=function(H,G){function p(){return B(a("group",{coordsize:e+" "+e,coordorigin:-h+" "+-h}),{width:e,height:e})
}function o(d,j,f){E(b,E(B(p(),{rotation:360/G.lines*d+"deg",left:~~j}),E(B(a("roundrect",{arcsize:G.corners}),{width:h,height:G.width,left:G.radius,top:-G.width>>1,filter:f}),a("fill",{color:y(G.color,d),opacity:G.opacity}),a("stroke",{opacity:0}))))
}var n,h=G.length+G.width,e=2*h,c=2*-(G.width+G.length)+"px",b=B(p(),{position:"absolute",top:c,left:c});
if(G.shadow){for(n=1;
n<=G.lines;
n++){o(n,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)")
}}for(n=1;
n<=G.lines;
n++){o(n)
}return E(H,b)
...
}(),r={lines:12,length:7,width:5,radius:10,rotate:0,corners:1,color:"#000",direction:1,speed:1,trail:100,opacity:0.25,fps:20,zIndex:2000000000,className:"spinner",top:"auto",left:"auto",position:"relative"};
...
if(P&&(P.insertBefore(K,P.firstChild||null),N=z(P),O=z(K),B(K,{left:("auto"==L.left?N.x-O.x+(P.offsetWidth>>1):parseInt(L.left,10)+J)+"px",top:("auto"==L.top?N.y-O.y+(P.offsetHeight>>1):parseInt(L.top,10)+J)+"px"})),K.setAttribute("role","progressbar"),M.lines(K,M.opts),!v){var I,H=0,G=(L.lines-1)*(1-L.direction)/2,k=L.fps,g=k/L.speed,e=(1-L.opacity)/(g*L.trail/100),a=g/L.lines;
!function Q(){H++;
for(var b=0;
b<L.lines;
b++){I=Math.max(1-(H+(L.lines-b)*a)%g*e,L.opacity),M.opacity(K,b*L.direction+G,I,L)
}M.timeout=M.el&&setTimeout(Q,~~(1000/k))
}()
}return M
...
},lines:function(k,h){function e(d,f){return B(F(),{position:"absolute",width:h.length+h.width+"px",height:h.width+"px",background:d,boxShadow:f,transformOrigin:"left",transform:"rotate("+~~(360/h.lines*b+h.rotate)+"deg) translate("+h.radius+"px,0)",borderRadius:(h.corners*h.width>>1)+"px"})
}for(var c,b=0,a=(h.lines-1)*(1-h.direction)/2;
b<h.lines;
b++){c=B(F(),{position:"absolute",top:1+~(h.width/2)+"px",transform:h.hwaccel?"translate3d(0,0,0)":"",opacity:h.opacity,animation:v&&D(h.opacity,h.trail,a+b*h.direction,h.lines)+" "+1/h.speed+"s linear infinite"}),h.shadow&&E(c,B(e("#000","0 0 4px #000"),{top:"2px"})),E(k,E(c,e(y(h.color,b),"0 0 1px rgba(0,0,0,.1)")))
}return k
},opacity:function(e,d,f){d<e.childNodes.length&&(e.childNodes[d].style.opacity=f)
}});
var q=B(F("group"),{behavior:"url(#default#VML)"});
return !C(q,"transform")&&q.adj?w():v=C(q,"animation"),x
});
/*! fontfaceonload - v0.1.7 - 2015-10-26
 * https://github.com/zachleat/fontfaceonload
 * Copyright (c) 2015 Zach Leatherman (@zachleat)
 * MIT License */
(function(h,j){var b="AxmTYklsjo190QW",f="sans-serif",g="serif",i=document.querySelector("html[dir=rtl]")!==null?"right":"left",c={tolerance:2,delay:100,glyphs:"",success:function(){},error:function(){},timeout:5000,weight:"400",style:"normal"},a=["display:block","position:absolute","top:-999px",i+":-999px","font-size:48px","width:auto","height:auto","line-height:normal","margin:0","padding:0","font-variant:normal","white-space:nowrap"],e='<div style="%s">'+b+"</div>";
var d=function(){this.fontFamily="";
this.appended=false;
...
d.prototype.getMeasurements=function(){return{sansSerif:{width:this.sansSerif.offsetWidth,height:this.sansSerif.offsetHeight},serif:{width:this.serif.offsetWidth,height:this.serif.offsetHeight}}
};
d.prototype.load=function(){var n=new Date(),w=this,t=w.serif,s=w.sansSerif,y=w.parent,u=w.appended,l,z=w.options,p=z.reference;
function x(A){return a.concat(["font-weight:"+z.weight,"font-style:"+z.style]).concat("font-family:"+A).join(";")
}var m=e.replace(/\%s/,x(f)),v=e.replace(/\%s/,x(g));
if(!y){y=w.parent=j.createElement("div")
}y.innerHTML=m+v;
s=w.sansSerif=y.firstChild;
t=w.serif=s.nextSibling;
if(z.glyphs){s.innerHTML+=z.glyphs;
t.innerHTML+=z.glyphs
}function q(C,B,A){return Math.abs(C.width-B.offsetWidth)>A||Math.abs(C.height-B.offsetHeight)>A
}function o(){return(new Date()).getTime()-n.getTime()>z.timeout
}(function r(){if(!p){p=j.body
}if(!u&&p){p.appendChild(y);
u=w.appended=true;
l=w.getMeasurements();
s.style.fontFamily=w.fontFamily+", "+f;
t.style.fontFamily=w.fontFamily+", "+g
}if(u&&l&&(q(l.sansSerif,s,z.tolerance)||q(l.serif,t,z.tolerance))){z.success()
}else{if(o()){z.error()
}else{if(!u&&"requestAnimationFrame" in window){h.requestAnimationFrame(r)
}else{h.setTimeout(r,z.delay)
}}}})()
};
d.prototype.cleanFamilyName=function(l){return l.replace(/[\'\"]/g,"").toLowerCase()
};
d.prototype.cleanWeight=function(m){var l={normal:"400",bold:"700"};
return""+(l[m]||m)
};
d.prototype.checkFontFaces=function(m){var l=this;
j.fonts.forEach(function(n){if(l.cleanFamilyName(n.family)===l.cleanFamilyName(l.fontFamily)&&l.cleanWeight(n.weight)===l.cleanWeight(l.options.weight)&&n.style===l.options.style){n.load().then(function(){l.options.success();
h.clearTimeout(m)
})
}})
};
d.prototype.init=function(l,n){var o;
for(var m in c){if(!n.hasOwnProperty(m)){n[m]=c[m]
}}this.options=n;
this.fontFamily=l;
if(!n.glyphs&&"fonts" in j){if(n.timeout){o=h.setTimeout(function(){n.error()
},n.timeout)
}this.checkFontFaces(o)
}else{this.load()
}};
var k=function(m,n){var l=new d();
l.init(m,n);
return l
};
h.FontFaceOnload=k
})(this,this.document);
FontFaceOnload("CiscoSans",{success:function(){if(jQuery('html[lang="en"]').length>0){document.documentElement.className+=" custom-font"
}},error:function(){console.log("failed to load custom font")
},timeout:10000});
jQuery(document).ready(function(){jQuery('html.ie[dir="rtl"] div:contains("AxmTYklsjo190QW")').css("left","auto")
});
if(typeof cdc==="undefined"){cdc={}
}if(typeof cdc.util==="undefined"){cdc.util={}
}cdc.util.ensureNamespace=function(b){if(!b){return
}var c=b.split(".");
var d=window;
var a;
var e;
